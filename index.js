...
//made a variable that used the function to filter the results to contain the winners
// const winners= record.filter(function superBowlWinners(record){
//     return record.result.includes("W");
// })
// console.log(winners);

// //did the same but for results with losing games
// const losers= record.filter(function superBowlLose(record){
//     return record.result.includes("L");
// })
// console.log(losers);
...
// let winner = record.find(obj => {obj.result === "W";})
// console.log(winner);
// function superBowlWin(record){
//     return record.indexOf('W')
// }
